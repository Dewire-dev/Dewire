    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                Si nécessaire, vous pouvez vous déconnecter de toutes vos autres sessions de navigation sur tous vos appareils.
                Certaines de vos sessions récentes sont répertoriées ci-dessous ; cependant, cette liste peut ne pas être exhaustive.
                Si vous pensez que votre compte a été compromis, vous devez également mettre à jour votre mot de passe.
            </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span v-else>Dernier activité {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
